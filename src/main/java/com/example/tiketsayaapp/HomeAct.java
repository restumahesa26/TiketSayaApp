...
public class HomeAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ticket_torri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gototorri = new Intent(HomeAct.this, TicketDetailAct.class);
                gototorri.putExtra("jenis_tiket", "Torri");
        ...
        btn_ticket_pagoda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotopagoda = new Intent(HomeAct.this, TicketDetailAct.class);
                gotopagoda.putExtra("jenis_tiket", "Pagoda");
        ...
        btn_ticket_candi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotocandi = new Intent(HomeAct.this, TicketDetailAct.class);
                gotocandi.putExtra("jenis_tiket", "Candi");
        ...
        btn_ticket_sphinx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotosphinx = new Intent(HomeAct.this, TicketDetailAct.class);
                gotosphinx.putExtra("jenis_tiket", "Sphinx");
        ...
        btn_ticket_monas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotomonas = new Intent(HomeAct.this, TicketDetailAct.class);
                gotomonas.putExtra("jenis_tiket", "Monas");
